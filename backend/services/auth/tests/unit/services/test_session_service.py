...
@pytest.fixture
def service(mock_async_session, mock_session_repo, mock_token_repo):
...
class TestSessionService:
    async def test_create_session_success(self, service, mock_request):
        ...
        with (
            ...
            await service.create(user_id, refresh_token_id, mock_request)
    ...
    async def test_update_session_success(self, service, mock_request):
        ...
        with (
            ...
            await service.update(refresh_token_id, mock_request)
