...
from app.external_api.core import BaseProvider, registry
from app.external_api.methods import smart_price_updater
from app.external_api.url_chunker import chunk_ids_for_url
...
class CoingeckoProvider(BaseProvider):
    ...
    async def get_prices(self, ids: list[str]) -> dict[str, Decimal]:
        ...
        if failed_chunks:
            logger.warning('Проблемные чанки: %s', failed_chunks)
